...
indexDict = {'code': 0, 'display_name': 1, 
            'name': 2, 'date': 3, 'open': 4, 
            'close': 5, 'high': 6, 'low': 7, 
            'pre_close': 8, 'volume': 9, 
            'money': 10, 'high_limit': 11, 
            'low_limit': 12, 'avg': 13, 'paused': 14, 
            'change_ratio': 15, 'change_price': 16, 
            'is_st': 17, 'volume_ratio': 18,
            'ma5': 19, 'ma10': 20, 'ma20': 21, 'ma30': 22, 'ma60': 23, 'ma180': 24}
attributeDict = {0: 'code', 1: 'display_name', 
            2: 'name', 3: 'date', 4: 'open', 
            5: 'close', 6: 'high', 7: 'low', 
            8: 'pre_close', 9: 'volume', 
            10: 'money', 11: 'high_limit', 
            12: 'low_limit', 13: 'avg', 14: 'paused', 
            15: 'change_ratio', 16: 'change_price', 
            17: 'is_st', 18: 'volume_ratio', 
